...
$lang['db_must_use_where'] = 'Atualizações(Updates) não são permitidas a menos que exista a cláusula "where".';
$lang['db_del_must_use_where'] = 'Exclusões(Deletes) não são permitidas a menos que exista a cláusula "where" ou "like".';
