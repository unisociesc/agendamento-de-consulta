...
$lang['appointment_details_was_sent_to_you'] = 'E-mail enviado com os detalhes do agendamento.';
...
$lang['disable_sync_prompt'] = 'Você está certo que quer desativar a sincronização do calendário?';
...
$lang['settings_hint'] = 'Definir as configurações do sistema e do usuário.';
$lang['log_out_hint'] = 'Sair do Sistema.';
$lang['unavailable_periods_hint'] = 'Durante os períodos indisponíveis o fornecedor não aceitar novos agendamentos.';
...
$lang['start_date_before_end_error'] = 'A data de início é após a data fim.';
$lang['invalid_email'] = 'E-mail inválido.';
$lang['customers'] = 'Clientes';
$lang['details'] = 'Detalhes';
$lang['no_records_found'] = 'Não foram encontrados registros...';
...
$lang['company_email_hint'] = 'Este será o endereço de e-mail da empresa. Ele será usado como o remetente e o endereço de resposta dos e-mails do sistema (obrigatório).';
...
$lang['edit_working_plan_hint'] = 'Marque os dias e as horas a que a sua empresa aceita agendamentos. Assim será possíveis os agendamentos em horário de atendimento, evitando que os clientes marquem agendamento fora do horário de atendimento. Este plano de trabalho será o padrão para cada novo registo de atendente, mas é possível mudar o plano de cada fornecedor separadamente editando o atendente. Depois disso, pode adicionar períodos de descanso.';
...
$lang['about_app_info'] = 'Easy!Appointments é uma aplicação web altamente personalizável que permite que os clientes marquem eventos através da internet. Além disso, oferece a possibilidade de sincronizar seus dados com o Google Calendar para que possa usá-los com outros serviços.';
$lang['current_version'] = 'Versão Atual';
$lang['support'] = 'Suporte';
$lang['about_app_support'] = 'Se encontrar algum problema ao usar o Easy!Appointments pode procurar o Grupo oficial do GitHub para obter respostas. Se precisar, pode iniciar um novo tópico na página do GitHub, a fim de ajudar o progresso do desenvolvimento.';
$lang['official_website'] = 'Site Oficial';
$lang['google_plus_community'] = 'Comunidade Google +';
$lang['support_group'] = 'Grupo de Suporte';
...
$lang['login_failed'] = 'Falha na autenticação, por favor inserir os seus dados de acesso e tentar novamente.';
$lang['type_username_and_email_for_new_password'] = 'Digite o seu nome de usuário e e-mail para ser gerado uma nova senha.';
$lang['enter_email_here'] = 'Insira o seu e-mail...';
$lang['regenerate_password'] = 'Alterar Senha';
$lang['go_to_login'] = 'Voltar à página de Login';
$lang['new_password_sent_with_email'] = 'A nova senha foi enviada para o seu e-mail.';
$lang['new_account_password'] = 'Senha para nova conta';
$lang['new_password_is'] = 'A nova senha da conta é $password Por favor, guarde este e-mail para ser possível recuperar, se necessário. Pode alterar a senha na página de configurações.';
...
$lang['backend_calendar'] = 'Painel de gerenciamento de calendário';
...
$lang['unavailable_updated'] = 'Período de tempo indisponível atualizado com sucesso.';
$lang['appointments'] = 'Agendamentos';
$lang['unexpected_warnings'] = 'Avisos Inesperados';
$lang['unexpected_warnings_message'] = 'A operação foi concluída, contudo existem avisos.';
$lang['filter'] = 'Filtrar';
$lang['clear'] = 'Limpar';
$lang['uncategorized'] = 'Sem Categoria';
$lang['username_already_exists'] = 'O Nome de usuário já existe.';
$lang['password_length_notice'] = 'A senha deve ter pelo menos $number de caracteres.';
...
$lang['require_captcha_hint'] = 'Quando habilitado, os clientes terão que digitar um código CAPTCHA gerado aleatoriamente antes de cadastrar/atualizar um agendamento.';
...
$lang['customer_notifications_hint'] = 'Define se o cliente receberá ou não, notificações por e-mail sempre que um de seus agendamentos sejam alterados de horário.';
$lang['date_format'] = 'Formato da Data';
$lang['date_format_hint'] = 'Altera o formato de visualização da Data (D - Dia, M - Mês, Y - Ano).';
...
$lang['first_weekday_hint'] = 'Definir o primeiro dia da semana do calendário.';
$lang['google_analytics_code_hint'] = 'Adicione o seu ID do Google Analytics para ser incluido na página de agendamentos.';
...
$lang['cookie_notice'] = 'Aviso de Cookie';
...
$lang['delete_personal_information_prompt'] = 'Tem certeza que deseja deletar suas informações pessoais? Essa ação não pode ser desfeita.';
...
$lang['working_plan_exceptions_hint'] = 'Adicionar um dia de exceção do plano de trabalho, fora do plano de trabalho.';
$lang['new_working_plan_exception_title'] = 'Nova Exceção de Plano de Trabalho';
$lang['working_plan_exception_saved'] = 'Exceção do plano de trabalho salvada com sucesso.';
$lang['working_plan_exception_deleted'] = 'Exceção do plano de trabalho deletada com sucesso.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Adicionar exceções de plano de trabalho, fora do plano de trabalho.';
$lang['add_working_plan_exception'] = 'Adicionar exceção plano de trabalho';
$lang['require_phone_number'] = 'Necessário número de telefone';
$lang['require_phone_number_hint'] = 'Quando ativo, clientes e usuários precisarão digitar o número de telefone ao marcar uma consulta';
$lang['check_spam_folder'] = 'Por favor, verifique a caixa de spam do seu e-mail se não chegou a poucos minutos.';
$lang['api_token_hint'] = 'Coloque um token secreto apara ativar o token de autenticação do Easy!Appointments API.';
$lang['timezone'] = 'Zona de tempo';
$lang['overwrite_existing_working_plans'] = 'Isso substituirá os planos de trabalho existentes do provedor, você tem certeza de que deseja continuar?';
$lang['working_plans_got_updated'] = 'Todos os planos de trabalho foram atualizados.';
$lang['apply_to_all_providers'] = 'Aplicar para todos os Provedores';
$lang['display_any_provider'] = 'Exibir qualquer opção de provedor';
$lang['display_any_provider_hint'] = 'A página de reserva terá uma opção adicional que permite que os clientes reservem sem especificar um provedor.';
$lang['load_more'] = 'Carregando mais';
$lang['list'] = 'Lista';
